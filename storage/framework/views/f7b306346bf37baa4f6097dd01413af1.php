<div id="radio-player-container"
     ...
     data-default-photo="<?php echo e(asset('images/genericprogramimage.png')); ?>"
     data-stream-url="<?php echo e(env('RADIO_STREAM_URL', 'https://a12.asurahosting.com/listen/dilinger/radio.mp3')); ?>"
  ...
  <div class="player-controls">
    ...
    <div class="station-branding">
      <img src="<?php echo e(asset('images/logo/logo.png')); ?>" alt="Logo de la Emisora" class="station-logo">
  ...
  <div id="program-details" class="program-details">
    <div class="program-grid">
      <div class="program-column director-photo-column">
        <img id="director-photo" src="<?php echo e(asset('images/logo/ImagenRadio.jpg')); ?>" alt="Foto del Director">
      </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eccav4/resources/views/player.blade.php ENDPATH**/ ?>