<?php $__env->startSection('title', 'Información del versículo diario'); ?>

<?php
$date = \Carbon\Carbon::parse($quote->date);
$dias = [
...
<?php $__env->startSection('pageheading', 'Versículo del día - ' . $textoFecha); ?>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                            ID: <?php echo e($quote->id); ?> • Fecha: <span class="font-mono text-xs"><?php echo e(\Carbon\Carbon::parse($quote->date)->format('d/m/Y')); ?></span>
                        </p>
                    </div>
                    <div class="flex-shrink-0">
                        <?php if($quote->deleted_at): ?>
        ...
        <div class="card">
            <div class="card-body p-6">
                ...
                <div class="rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-800 cursor-pointer group" id="quoteImage">
                    <img src="<?php echo e(asset('images/bible/' . $quote->image)); ?>"
        ...
        <div class="card">
            <div class="card-body p-6">
                ...
                <div class="bg-slate-100 dark:bg-slate-800 rounded-lg p-4 text-center">
                    ...
                    <a href="<?php echo e(asset('documents/quote/' . $quote->video)); ?>"
                        target="_blank"
                ...
                <details class="mt-4">
                    ...
                    <div class="mt-2 border rounded-lg overflow-hidden">
                        <iframe src="<?php echo e(asset('/laraview/#../documents/quote/' . $quote->video)); ?>"
                            width="100%"
                            height="500px"
                            class="border-0">
                        </iframe>
            ...
            <div class="card-body p-6">
                ...
                <div class="bg-slate-100 dark:bg-slate-800 rounded-lg p-4">
                    <audio controls class="w-full">
                        <source src="<?php echo e(asset('audio/quote/' . $quote->audio)); ?>" type="audio/mpeg">
                ...
                <div class="card-body p-6">
                    ...
                    <dl class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm text-slate-900 dark:text-slate-100"><?php echo e(\Carbon\Carbon::parse($quote->date)->format('d/m/Y')); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-slate-500 dark:text-slate-400">Creado:</dt>
                            <dd class="text-sm text-slate-900 dark:text-slate-100"><?php echo e($quote->created_at->format('d/m/Y H:i')); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-slate-500 dark:text-slate-400">Actualizado:</dt>
                            <dd class="text-sm text-slate-900 dark:text-slate-100"><?php echo e($quote->updated_at->format('d/m/Y H:i')); ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <button class="btn btn-info w-full justify-center" data-modal-open="EditModal_<?php echo e($quote->id); ?>">
                            <i class="fas fa-edit mr-2"></i> Editar Versículo
                        </button>

                        
                        <?php if($quote->deleted_at): ?>
                        <a href="<?php echo e(url('activate-quote', $quote->id)); ?>" class="btn btn-success w-full justify-center">
                            <i class="fas fa-toggle-on mr-2"></i> Activar
                        </a>
                        <?php else: ?>
                        <a href="<?php echo e(url('delete-quote', $quote->id)); ?>" class="btn btn-warning w-full justify-center">
                            <i class="fas fa-power-off mr-2"></i> Desactivar
                        </a>
                        <?php endif; ?>

                        
                        <form action="<?php echo e(url('realdelete-quote', $quote->id)); ?>" method="POST" onsubmit="return confirm('¿Está seguro de que desea eliminar este versículo permanentemente?');" class="inline w-full">
                            <?php echo csrf_field(); ?>
                        ...
                        <a href="<?php echo e(url('show-quote')); ?>" class="btn btn-secondary w-full justify-center">
...
<section id="imageModal" class="tw-modal" aria-modal="true" role="dialog" aria-hidden="true">
    <div class="tw-modal-panel max-w-5xl">
        <div class="tw-modal-header">
            <h3 class="text-lg font-semibold">Versículo del día - <?php echo e(\Carbon\Carbon::parse($quote->date)->format('d/m/Y')); ?></h3>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eccav4/resources/views/admin/quote/view-quote.blade.php ENDPATH**/ ?>