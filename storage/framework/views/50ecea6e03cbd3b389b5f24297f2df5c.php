  ...
  <div class="login-card">
        ...
        <div class="alert-error">
          <div class="flex items-start">
            ...
            <div>
              ...
              <p class="mt-1"><?php echo e($errors->first('email') ?: $errors->first('password') ?: 'Credenciales incorrectas'); ?></p>
            </div>
          </div>
        </div>
      <?php endif; ?>
      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="link-forgot">
          <?php if(Route::has('password.request')): ?>
            <a href="<?php echo e(route('password.request')); ?>" class="text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-500 transition-colors">¿Olvidaste tu contraseña?</a>
          <?php endif; ?>
        </div>
      </div>
    ...
    <?php if(Route::has('register')): ?>
      <div class="register-message">
        <p>¿No tienes una cuenta? <a href="<?php echo e(route('register')); ?>">Regístrate aquí</a></p>
      </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/eccav4/resources/views/auth/login.blade.php ENDPATH**/ ?>