{{-- Colócalo en el sidebar con data-turbo-permanent para que no se corte al navegar --}}
<div id="miniPlayer" class="card">
    <div class="card-body">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-lg overflow-hidden ring-1 ring-black/10 dark:ring-white/10">
                {{-- Logo / portada (opcional) --}}
                <img src="{{ asset('images/logo/logo.png') }}" alt="ECCA" class="w-full h-full object-cover">
            </div>
            <div class="min-w-0">
        ...
        <div class="mt-3">
            <audio id="audioStream" src="{{ config('app.stream_url') }}" controls preload="none" class="w-full"></audio>
        </div>
