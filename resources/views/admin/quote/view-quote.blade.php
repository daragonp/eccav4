...
@section('pageheading', 'Versículo del día - ' . $textoFecha)
        ...
        <div class="card">
            <div class="card-body p-6">
                ...
                <div class="flex justify-center">
                    <div class="rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-800 cursor-pointer group max-w-md w-full" id="quoteImage">
