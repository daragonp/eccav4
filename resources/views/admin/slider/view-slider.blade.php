            ...
            <div class="card">
                <div class="card-body p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        {{-- Activar / Desactivar --}}
                        @if ($slider->active)
                            <a href="{{ url('delete-slider', $slider->id) }}" class="btn btn-warning w-full justify-center">
                                <i class="fas fa-power-off mr-2"></i> Desactivar
                            </a>
                        @else
                            <a href="{{ url('activate-slider', $slider->id) }}" class="btn btn-success w-full justify-center">
