      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="link-forgot">
          @if (Route::has('password.request'))
            <a href="{{ route('password.request') }}" class="text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-500 transition-colors">¿Olvidaste tu contraseña?</a>
          @endif
        </div>
      </div>
