  ...
  <div class="privacy-notice-modal">
    ...
    <div class="privacy-notice-content">
      ...
      <section class="privacy-section">
        ...
        <ul style="list-style: none; padding: 0;">
          <li><a href="{{ route('privacy-policy') }}" target="_blank" class="privacy-link">
            <i class="fas fa-external-link-alt"></i> Política de Privacidad Completa
          </a></li>
          <li><a href="{{ route('cookies-policy') }}" target="_blank" class="privacy-link">
            <i class="fas fa-external-link-alt"></i> Política de Cookies
          </a></li>
          <li><a href="{{ route('terms-conditions') }}" target="_blank" class="privacy-link">
